...
library EscrowStorageSlot {
    ...
    bytes32 internal constant S_LIQUIDITY_TOKEN_REPO_INCENTIVE =
        $$(keccak256("notional.escrow.liquidityTokenRepoIncentive"));
...
contract EscrowStorage {
    ...
    bytes32 internal constant TOKENS_RECIPIENT_INTERFACE_HASH =
