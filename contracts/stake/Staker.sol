...
contract Staker is ReentrancyGuard, Ownable {
    ...
    function mint(address user, uint256 amount) external updateReward(user) {
        ...
        vault.approveToStaker(amount);
        stakingToken.safeTransferFrom(address(vault), address(this), amount);
    ...
    // 添加收益到 staking 合约， 更新 reward Data
